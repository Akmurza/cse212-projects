...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue was implemented as LIFO (stack) instead of FIFO (queue), causing wrong order. Turn logic re-enqueueing was incorrect
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Same as up there.
